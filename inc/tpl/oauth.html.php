<div class="wrapper">
	...
	<div class="row">
		...
		<form action="?" method="GET">
			<input type="text" name="access_token" value="" placeholder="access token" size="32" />
			<input type="hidden" name="type" value="VK_SCHED" />
			<input type="hidden" name="a" value="oauth" />
			<input type="submit" class="btn" value="GO" />
		</form>
	</div>
	...
	<div class="row">
		<a href="<?= $vk_oauth ?>">VK Grabber OAuth</a> (<?= $vk_users['VK_GRABBER'] ?>)
		<form action="?" method="GET">
			<input type="text" name="code" value="" placeholder="code" size="32" />
			<input type="hidden" name="state" value="VK_GRABBER" />
			<input type="hidden" name="a" value="oauth" />
			<input type="submit" class="btn" value="GO" />
		</form>
		<div class="pad_t"></div>
		<form action="?" method="GET">
			<input type="text" name="access_token" value="" placeholder="access token" size="32" />
			<input type="hidden" name="type" value="VK_GRABBER" />
			<input type="hidden" name="a" value="oauth" />
			<input type="submit" class="btn" value="GO" />
		</form>
	</div>
